...
just as I did with the knight's tour problem, I straight out copied it this one,
since I needed to understand how backtracking works in these sort of problems
